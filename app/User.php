    ...
    CanResetPasswordContract
{
    ...
    {
        return $this->belongsToMany('App\Message', 'candybrush_messages_recievers','candybrush_messages_recievers_user_id','candybrush_messages_recievers_message_id')->withTimestamps();
    }
}