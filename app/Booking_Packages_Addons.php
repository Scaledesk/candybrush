...
class Booking_Packages_Addons extends Model
{
    ...
    protected $fillable=[self::NAME,self::DESCRIPTION,self::PACKAGE_ID,self::DAYS,self::AMOUNT,self::TERMS,self::BOOKING_ID,self::ADDON_ID];
    ...
    const ADDON_ID="candybrush_bookings_addons_addon_id";
    ...
    public function addon(){
        return $this->belongsTo('App\Addon','candybrush_bookings_addons_addon_id');
    }
